...
CARD_EFFECTS = {
    ...
    "剪刀": "贏布,輸石頭,平剪刀。",
    "殞石頭": (
        "①:本回合出示的星星為「石頭」時可以發動,使其升級為殞石頭"
        "(贏 石頭/剪刀/雷射剪刀,平 布,輸 鈦合金布)。種類不符時,此卡直接返回手牌。"
    ),
    "雷射剪刀": (
        "①:本回合出示的星星為「剪刀」時可以發動,使其升級為雷射剪刀"
        "(贏 剪刀/布/鈦合金布,平 石頭,輸 殞石頭)。種類不符時,此卡直接返回手牌。"
    ),
    "鈦合金布": (
        "①:本回合出示的星星為「布」時可以發動,使其升級為鈦合金布"
        "(贏 布/石頭/殞石頭,平 剪刀,輸 雷射剪刀)。種類不符時,此卡直接返回手牌。"
    ),
    "烈陽": (
    ...
    "偷變石頭": "①:此卡需事先蓋放。可以發動,將自己本回合的星星變更為「石頭」。",
    "偷變剪刀": "①:此卡需事先蓋放。可以發動,將自己本回合的星星變更為「剪刀」。",
    "偷變布": "①:此卡需事先蓋放。可以發動,將自己本回合的星星變更為「布」。",
    "日蝕": (
        "①:對手發動烈陽時,此卡已蓋放可發動。使其無效並丟棄,"
